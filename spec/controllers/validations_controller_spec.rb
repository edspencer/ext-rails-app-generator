...
describe ValidationsController do
  ...
  def mock_validation(stubs={})
    ...
    @mock_validation ||= mock_model(Validation, stubs)
  end
  ...
  describe "responding to POST create" do
    ...
    def do_request
      post :create, :validation => {:these => 'params'}, :site_id => @site.id, :model_id => @model.id
    end
  end
  ...
  describe "responding to PUT update" do
    ...
    def do_request
      put :update, :id => "1", :validation => {:these => 'params'}
    end
  end
  ...
  describe "responding to DELETE destroy" do
    ...
    it "should redirect to the edit model screen" do
      @validations.stub!(:find).and_return(mock_validation(:destroy => true))
      do_request
