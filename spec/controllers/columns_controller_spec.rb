...
describe ColumnsController do
  ...
  def mock_column(stubs={})
    ...
    @mock_column ||= mock_model(Column, stubs)
  end
  ...
  describe "responding to POST create" do
    ...
    def do_request
      post :create, :column => {:these => 'params'}, :site_id => @site.id, :model_id => @model.id
    end
  end
  ...
  describe "responding to PUT update" do
    ...
    def do_request
      put :update, :id => "1", :column => {:these => 'params'}
    end
  end
  ...
  describe "responding to DELETE destroy" do
    ...
    it "should redirect to the edit model screen" do
      @columns.stub!(:find).and_return(mock_column(:destroy => true))
      do_request
